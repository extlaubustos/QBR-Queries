...
          WHEN RETAINED_BASE AND RETAINED_MAS_1 AND RETAINED_MAS_2 AND RETAINED_MAS_3 AND RETAINED_MAS_4 AND RETAINED_MAS_5 AND RETAINED_MAS_6  AND  RETAINED_MAS_7 AND NOT  RETAINED_MAS_8 THEN 'M8'
          WHEN RETAINED_BASE AND RETAINED_MAS_1 AND RETAINED_MAS_2 AND RETAINED_MAS_3 AND RETAINED_MAS_4 AND RETAINED_MAS_5 AND RETAINED_MAS_6  AND  RETAINED_MAS_7 AND RETAINED_MAS_8 AND NOT  RETAINED_MAS_9 THEN 'M9'
          WHEN RETAINED_BASE AND RETAINED_MAS_1 AND RETAINED_MAS_2 AND RETAINED_MAS_3 AND RETAINED_MAS_4 AND RETAINED_MAS_5 AND RETAINED_MAS_6  AND  RETAINED_MAS_7 AND RETAINED_MAS_8 AND RETAINED_MAS_9 AND NOT  RETAINED_MAS_10 THEN 'M10'
          WHEN RETAINED_BASE AND RETAINED_MAS_1 AND RETAINED_MAS_2 AND RETAINED_MAS_3 AND RETAINED_MAS_4 AND RETAINED_MAS_5 AND RETAINED_MAS_6  AND  RETAINED_MAS_7 AND RETAINED_MAS_8 AND RETAINED_MAS_9 AND RETAINED_MAS_10 AND NOT  RETAINED_MAS_11 THEN 'M11'
          ELSE 'OTROS'

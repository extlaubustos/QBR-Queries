...
FROM SESSION_PLAY s
GROUP BY ALL
ORDER BY MONTH_ID DESC, SIT_SITE_ID ASC, DEVICE_PLATFORM ASC
),
BASE_WEEKLY AS (
  SELECT 
...
FROM SESSION_PLAY s
GROUP BY ALL
ORDER BY WEEK_ID DESC, SIT_SITE_ID ASC, DEVICE_PLATFORM ASC
),
BASE_DAILY AS (
  SELECT 
...
FROM SESSION_PLAY s
GROUP BY ALL
ORDER BY DS DESC, SIT_SITE_ID ASC, DEVICE_PLATFORM ASC
)

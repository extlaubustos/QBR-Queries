...
CREATE OR REPLACE TABLE `meli-sbox.MPLAY.NEGOCIO_MPLAY_CONTENT_DATA_USER` PARTITION BY TIME_FRAME_ID CLUSTER BY SIT_SITE_ID,CONTENT_ID,USER_ID
 AS (
...
CREATE OR REPLACE TABLE `meli-sbox.MPLAY.NEGOCIO_MPLAY_CONTENT_PERFORMANCE_SCORES_V2` PARTITION BY TIME_FRAME_ID CLUSTER BY SIT_SITE_ID, CONTENT_TYPE AS (

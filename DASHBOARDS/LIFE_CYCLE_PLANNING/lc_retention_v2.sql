-- description: Retención y churn de usuarios a 30 días basada en consumo de TVM, segmentada por plataforma y rango de minutos reproducidos.
-- domain: behaviour
-- product: mplay
-- use_case: retention / churn_analysis

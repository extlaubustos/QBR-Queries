...
SUM(PLAYBACK_TIME_MILLISECONDS_CAST) AS PLAYBACK_TIME_MILLISECONDS_CAST,
...
SUM(CASE WHEN ud.PLAYBACK_TIME_MILLISECONDS_CAST/1000 >= 20 THEN ud.PLAYBACK_TIME_MILLISECONDS_CAST/60000 ELSE 0 END) AS TOTAL_CAST

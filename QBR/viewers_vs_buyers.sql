...
BUYERS_VIEWERS AS (
  SELECT
    ...
    b.SIT_SITE_ID,
    COUNT(DISTINCT b.USER_ID) AS TOTAL_BUYERS,
    COUNT(DISTINCT v.USER_ID) AS TOTAL_VIEWERS_BUYERS
  FROM BUYERS_MARKETPLACE b
  LEFT JOIN VIEWERS_PLATFORM_LABELLED v
    ON b.USER_ID = v.USER_ID
    AND b.MONTH_ID = v.MONTH_ID
    AND b.SIT_SITE_ID = v.SIT_SITE_ID
  GROUP BY 1, 2
)

-- description: Métricas de engagement de usuarios por origen, plataforma y clasificación para MTD
-- domain: behaviour
-- product: mplay
-- use_case: reporting
-- grain: sit_site_id, origin, platform, user_classification, team
-- time_grain: month_to_date
-- date_column: DS
-- date_filter: from start of month to yesterday
...
-- - BASE_MPLAY_MTD joins CLASSIFICATION_ORIGINS y LK_MPLAY_SOURCE_TYPE_ORIGIN_SESSION por origin
-- owner: data_team
